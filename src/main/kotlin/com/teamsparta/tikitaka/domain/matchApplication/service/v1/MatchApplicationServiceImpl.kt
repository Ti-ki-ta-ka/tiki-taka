...
class MatchApplicationServiceImpl
    ...
    @Transactional
    override fun applyMatch(userId: Long, request: CreateApplyRequest, matchId: Long): MatchApplyResponse {
    ...
    @Transactional
    override fun deleteMatch(principal: UserPrincipal, applicationId: Long) {
